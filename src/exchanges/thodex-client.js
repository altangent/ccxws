...
class ThodexClient extends BasicMultiClient {
  constructor(options = {}) {
    super();
  ...
  _createBasicClient() {
    return new ThodexSingleClient({ ...this.options, parent: this });
  }
}

class ThodexSingleClient extends BasicClient {
  constructor({ wssPath = "wss://wspub.thodex.com", watcherMs = 900 * 1000, parent }) {
    super(wssPath, "Thodex", undefined, watcherMs);
